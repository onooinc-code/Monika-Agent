...
export const MessageInput: React.FC = () => {
    ...
    return (
        <footer className="glass-pane p-4 z-10 flex flex-col items-center">
            ...
            <div className="w-full max-w-2xl">
                        ...
                        <div className="flex justify-between items-end p-2.5">
                            <div className="flex items-center gap-2">
                                <input
                                    ...
                                    id="file-input-v2"
                                />
                                <button onClick={() => fileInputRef.current?.click()} className="text-gray-700 hover:text-white hover:-translate-y-1 transition-all" title="Attach an image">
                                    <AttachmentIconV2 />
                                </button>
                                <button className="text-gray-700 hover:text-white hover:-translate-y-1 transition-all" title="Add template">
                                    <GridIcon />
                                </button>
                                <button className="text-gray-700 hover:text-white hover:-translate-y-1 transition-all" title="Browse web">
                                    <GlobeIcon />
                                </button>
                            </div>
                             <button
                ...
                <div className="flex justify-center gap-2 mt-3.5">
                    <button className="px-3 py-1 bg-[#1b1b1b] border-2 border-[#363636] rounded-lg text-white text-xs hover:bg-[#363636] transition-colors">Create An Image</button>
                    <button className="px-3 py-1 bg-[#1b1b1b] border-2 border-[#363636] rounded-lg text-white text-xs hover:bg-[#363636] transition-colors">Analyse Data</button>
                    <button className="px-3 py-1 bg-[#1b1b1b] border-2 border-[#363636] rounded-lg text-white text-xs hover:bg-[#363636] transition-colors">More</button>
                </div>
            </div>
        </footer>
    );
