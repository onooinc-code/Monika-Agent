    ...
    return (
        <div className="profile-actions-wrapper">
            <style>{`
                ...
                .profile-actions-wrapper .value:not(:active):hover,
                .profile-actions-wrapper .value:focus {
                    background-color: #21262c;
                }

                .profile-actions-wrapper .value:focus,
                .profile-actions-wrapper .value:active {
                    background-color: #1a1f24;
                    outline: none;
                }

                .profile-actions-wrapper .value::before {
                    content: "";
                    position: absolute;
                    top: 5px;
                    left: -5px;
                ...
                .profile-actions-wrapper .value:focus::before,
                .profile-actions-wrapper .value:active::before {
                    opacity: 1;
                }

                .profile-actions-wrapper .value svg {
                    width: 14px;
                    height: 14px;
                }
            `}</style>
            <div className="input">
                <button className="value" title="Public Profile">
                    <svg
                        viewBox="0 0 16 16"
                ...
                <button className="value" title="Account Settings">
                ...
                <button className="value" title="Appearance">
                ...
                <button className="value" title="Notifications">
