...
export const SettingsGlassIcon = ({ className = 'w-5 h-5' }: { className?: string }) => (
  <svg
    className={className}
    viewBox="0 0 64 64"
    fill="none"
  ...
  >
    <defs>
      <linearGradient id="grad-glass-indigo" x1="0%" y1="0%" x2="0%" y2="100%">
        <stop offset="0%" stopColor="#818cf8" />
        <stop offset="100%" stopColor="#4f46e5" />
      </linearGradient>
      <filter id="shadow-glass-btn-settings" x="-20%" y="-20%" width="140%" height="140%">
        <feDropShadow dx="1" dy="2" stdDeviation="2" floodColor="#000000" floodOpacity="0.4"/>
      </filter>
    </defs>
    <g filter="url(#shadow-glass-btn-settings)">
      <rect x="4" y="4" width="56" height="56" rx="16" fill="url(#grad-glass-indigo)" />
