  ...
  return (
      ...
      <div className="relative group h-full">
        ...
        <div className="relative bg-white dark:bg-gray-900 rounded-xl p-1 shadow-xl h-full w-full flex flex-col">
          <div className="flex items-center justify-between mb-2">
             ...
             <div className="relative w-full overflow-hidden rounded-lg p-1 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 flex items-center justify-between">
    ...
    <div className="flex items-center">
        ...
        >
          ...
          <div className="grid grid-cols-3 gap-1 mb-2  flex items-center justify-center flex-1">
            <div className="relative  flex items-center justify-center overflow-hidden rounded-lg p-1 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900">
              <div className="relative z-10">
                <span className="block  flex items-center justify-center text-xl font-bold"
        ...
        <div
    className="relative bottom-0 h-0.5 rounded-full mx-auto"
    style={{
        width: '90%',
